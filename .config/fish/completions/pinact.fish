...
function __pinact_perform_completion
    ...
    for line in $results
        if not string match -q -- "pinact*" $line
...
# Clear existing completions for pinact
complete -c pinact -e
# Register completion function
complete -c pinact -f -a '(__pinact_perform_completion)'